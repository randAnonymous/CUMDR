...
2) **Uncertainty-aware Complementary Matching:** Designed to address the detrimental impact of pairs characterized by excessive uncertainty, this component incorporates external matching strategies.
...
![CUMDR](fig/framework-8.15_00.png)

## Proposed Model (CUMDR)
* Cross-modal Uncertainty Modeling
* Uncertainty-aware Complementary Matching
